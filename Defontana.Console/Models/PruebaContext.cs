...
namespace Defontana.Console.Models
{
    public partial class PruebaContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=lab-defontana.caporvnn6sbh.us-east-1.rds.amazonaws.com;Database=Prueba;Trusted_connection=true;User Id=ReadOnly;Password=d*3PSf2MmRX9vJtA5sgwSphCVQ26*T53uU;Integrated Security=false;TrustServerCertificate=true");
            }
        }
